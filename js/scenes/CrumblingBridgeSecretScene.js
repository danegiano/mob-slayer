class CrumblingBridgeSecretScene extends Phaser.Scene {
    constructor() { super('CrumblingBridgeSecret'); }

    create() {
        this.cameras.main.setBackgroundColor('#1a1a2e');
        this.add.rectangle(200, 150, 400, 300, 0x3e2a1e).setDepth(0);

        // Torches (orange for ruins theme)
        ...
        // 200 gold chest
        this.chest = new Chest(this, 200, 100, 'crumblingBridgeGold', {
        ...
        this.add.text(200, 30, 'Bridge Vault', { fontSize: '14px', fill: '#ddaa44' }).setOrigin(0.5).setDepth(50);
