class BossArenaSecretScene extends Phaser.Scene {
    constructor() { super('BossArenaSecret'); }
    ...
    create() {
        ...
        // Potion chest (heals 150 HP = 3 potions worth)
        this.chest = new Chest(this, 200, 100, 'bossArenaPotion', {
            type: 'potion', amount: 150, name: 'Health Potion x3'
        });
