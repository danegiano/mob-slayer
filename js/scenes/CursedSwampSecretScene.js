class CursedSwampSecretScene extends Phaser.Scene {
    constructor() { super('CursedSwampSecret'); }
    ...
    create() {
        ...
        // Dragon Armor chest
        this.chest = new Chest(this, 200, 100, 'cursedSwampArmor', {
            type: 'armor', id: 'dragon', name: 'Dragon Armor (DEF 60%)'
        });
        ...
        this.add.text(200, 30, 'Swamp Vault', { fontSize: '14px', fill: '#88ff88' }).setOrigin(0.5).setDepth(50);
