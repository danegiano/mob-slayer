class BlizzardPassSecretScene extends Phaser.Scene {
    constructor() { super('BlizzardPassSecret'); }
    ...
    create() {
        ...
        // 250 gold chest
        this.chest = new Chest(this, 200, 100, 'blizzardPassGold', {
            type: 'gold', amount: 250, name: '250 Gold'
        });
        ...
        this.add.text(200, 30, 'Blizzard Vault', { fontSize: '14px', fill: '#44aaff' }).setOrigin(0.5).setDepth(50);
